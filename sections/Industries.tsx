          ...
          {content.items.map((name) => {
            ...
            return (
              <motion.div
                ...
                className="group flex flex-col items-center justify-center gap-3 rounded-2xl border border-border bg-white px-4 py-8 text-center shadow-xs transition-all duration-[400ms] ease-[var(--ease-out)] hover:-translate-y-1.5 hover:border-primary-200 hover:shadow-md"
              >
